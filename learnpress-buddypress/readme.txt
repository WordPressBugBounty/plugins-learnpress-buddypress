...
= 3.0.5 =
~ Fix conflict status which happens with Orders page when using Woocommerce.

= 3.0.4 =
~ Fixed bug Fatal error on buddyPress profile page

= 3.0.3 =
~ Fixed bug get 404 page when access courses tab in member BuddyPress when the slug in profile tab (in LearnPress Settings) is not set.

= 3.0.2 =
+ Fix bug courses tab in buddpress profile page error 404
+ Update Buddypress profile courses content

= 3.0.1 =
+ Update Buddypress profile quizzes content
...
= 2.0.3 =
+ Upgrade text domain
+ make tab slugs work with profile setting of LearnPress plugin.
